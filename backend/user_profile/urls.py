...
urlpatterns = [
    ...
    path('accept_friend/<str:username>/', views.accept_friend_request, name='accept_friend_request'),
    path('reject_friend/<str:username>/', views.reject_friend_request, name='reject_friend_request'),
